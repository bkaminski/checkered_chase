  ...
  <div class="section-in-small service-hero">
    ...
    <div class="container-1140 hero-container">
      <div class="home-header">
        ...
        <div class="right-nav"><img src="<?php echo get_home_url(); ?>/wp-content/uploads/menu-icon.png" loading="lazy" data-w-id="946b9886-b467-d89b-d03e-f8174b418c64" sizes="(max-width: 767px) 11vw, 8vw" class="leaderboard-trigger"></div>
      </div>
    </div>
  </div>
  <div class="section-in-small contact-main">
    <div class="container-1140 contact-container">
